class BaselinesController < ApplicationController
  ...
  def show
    ...
    if params[:back_button]
      @baseline.update_attributes!(baseline_params)
      ...
      if @baseline.update_attributes!(baseline_params)
  ...
  def create
    @baseline = Baseline.create(params[:baseline])
    if @baseline.save
