class Baseline < ActiveRecord::Base
   ...
   def steps
   	%w[general_demo sfmfa phq whoqol_bref positive_negative mses_self pam spsir change_questionnaire prosthesis stop cognitive fci comorbidity pain mspss audit ]
   end
