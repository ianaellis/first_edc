class TreatmentCompletion < ActiveRecord::Base
	...
	belongs_to :subject
	attr_accessible :subject_id, :panas_present_moment_or_last_week, :tc_crf_status
    ...
    attr_accessible :administration_method, :tc_smoking_1, :tc_smoking_2, :tc_smoking_3, :tc_amp_side, :tc_fuq_2, :tc_fuq_2a, :tc_fuq_3, :tc_fuq_3a, :tc_fuq_4, :tc_fuq_4a_level, :tc_fuq_4a_type, :tc_fuq_4b, :tc_fuq_5, :tc_fuq_5a, :tc_fuq_6, :tc_fuq_6a, :tc_fuq_7
    attr_accessible :tc_mses_1, :tc_mses_2, :tc_mses_3, :tc_mses_4, :tc_mses_5, :tc_mses_6, :tc_mses_7, :tc_mses_8, :tc_mses_9, :tc_pu_2_bilateral_left, :tc_pu_3_bilateral_left
	...
	def steps
		%w[status smfa phq whoqol_bref positive_negative mses_self pam spsir ssscq prosthesis pain mspss audit accessing_resources 6week_review]   
	end
