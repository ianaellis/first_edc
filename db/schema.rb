...
ActiveRecord::Schema.define(version: 20170823164016) do
  ...
  create_table "baselines", force: :cascade do |t|
    ...
    t.index ["subject_id"], name: "index_baselines_on_subject_id"
  end

  create_table "crf_table", force: :cascade do |t|
    t.integer "subject_id"
    t.integer "pref_rand"
  ...
  create_table "data_queries", force: :cascade do |t|
    t.integer "subject_id"
  ...
  create_table "follow_up18_weeks", force: :cascade do |t|
    t.integer "subject_id"
    ...
    t.index ["subject_id"], name: "index_follow_up18_weeks_on_subject_id"
  end

  create_table "follow_up1_years", force: :cascade do |t|
    t.integer "subject_id"
    ...
    t.index ["subject_id"], name: "index_follow_up1_years_on_subject_id"
  end

  create_table "follow_up3_weeks", force: :cascade do |t|
    t.integer "subject_id"
    ...
    t.index ["subject_id"], name: "index_follow_up3_weeks_on_subject_id"
  end

  create_table "follow_up6_months", force: :cascade do |t|
    t.integer "subject_id"
    ...
    t.index ["subject_id"], name: "index_follow_up6_months_on_subject_id"
  end

  create_table "follow_up6_weeks", force: :cascade do |t|
    t.integer "subject_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["subject_id"], name: "index_follow_up6_weeks_on_subject_id"
  end

  create_table "follow_up_logs", force: :cascade do |t|
    t.integer "site"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "psychosocial_scales", force: :cascade do |t|
  ...
  create_table "subjects", force: :cascade do |t|
    ...
    t.integer "sc_pe_3a"
    t.integer "sc_exc_4"
    t.string "sc_pe_5o_reason"
    t.string "comments"
  end

  create_table "treatment_completions", force: :cascade do |t|
    t.integer "subject_id"
    t.integer "tc_smfa_1"
    t.integer "tc_smfa_2"
    t.integer "tc_smfa_3"
    ...
    t.string "tc_fuq_7"
    t.string "tc_ar_9"
    t.index ["subject_id"], name: "index_treatment_completions_on_subject_id"
  end
